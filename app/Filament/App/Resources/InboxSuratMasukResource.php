...
use App\Filament\App\Resources\InboxSuratMasukResource\Pages;
use App\Filament\App\Resources\InboxSuratMasukResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('tanggal_surat')->dateTime('d-F-Y H:i:s')->sortable()->searchable(),
