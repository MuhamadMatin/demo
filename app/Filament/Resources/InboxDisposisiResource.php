...
use App\Filament\Resources\InboxDisposisiResource\Pages;
use App\Filament\Resources\InboxDisposisiResource\RelationManagers;

class InboxDisposisiResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListInboxDisposisis::route('/'),
        ];
    }
}
